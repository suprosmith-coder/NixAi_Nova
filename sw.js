/* ════════════════════════════════════════════════════════════════
   ...
   FIXED v13:
   ✓ Removed optional catch binding (catch{} → catch(e){})
   ✓ Removed optional chaining (?.) → explicit null checks
   ✓ All modern syntax replaced with widely-supported equivalents
   ✓ HTML + JS + CSS  → NETWORK-FIRST (never serve stale code)
   ✓ Nuclear cache clear on activate
   ✓ Images / icons   → Cache-first
   ✓ Supabase / Groq  → Bypass (never cache)
